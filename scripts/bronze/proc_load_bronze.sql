...
Script Purpose:
      ...
      It performs the following actions:
          - Truncates the bronze tables before laoding the data.
          - Uses 'BULK INSERT' command to laod data from CSV files to bronze tables.
...
BEGIN
	...
	BEGIN TRY
		...
		FROM 'C:\Users\Asus\Downloads\source_erp\CUST_AZ12.csv'
		WITH (
			FIRSTROW = 2,
			FIELDTERMINATOR =',',
			TABLOCK);
		...
		FROM 'C:\Users\Asus\Downloads\source_erp\LOC_A101.csv'
		WITH (
			FIRSTROW = 2,
			FIELDTERMINATOR = ',',
			TABLOCK);
		...
		FROM 'C:\Users\Asus\Downloads\source_erp\PX_CAT_G1V2.csv'
		WITH (
			FIRSTROW = 2,
			FIELDTERMINATOR = ',',
			TABLOCK);
